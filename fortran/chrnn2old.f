      subroutine chrnn
c     
c    third revision started Jan. 28, 2020.
...
c
     ...
     3'c0  ','c1  ','l2  ','ssl2','l200','l201','l210','l211','    '/
c
...
c
 2920 fac=fac*c(mm,mes)*yukx2/xr6
     ...
     3   *(36.d0+72.d0*xrc+52.d0*xrc2+17.d0*xrc3+2.d0*xrc4))
      ...
      facpq=0.d0
      go to 95
c     central isoscalar term for c square 
...
c      spin tensor term for c square
...
c      central isovector term for ci/mn
 3610 fac=fac*c(mm,mes)*(1.d0/xrc5)*((5.d0+25*ga2+4.d0*ga2*xrc2)
...
c
 3820 fac=fac*c(mm,mes)*(yukx2/xr6
     ...
     4   +yrc4-4.d0*xrc2*(8.d0+5.d0*yrc+yrc2)))
      ...
      facpq=0.d0
      go to 95
c     central isoscalar term for ci/mn 
...
c     isovector spin and tensor term
...
c     isoscalar spin and tensor term
...
c     isovector central component
 4310 fac=fac*c(mm,mes)*(1.d0/xrc7)*((30.d0+89.d0*xrc2-8.d0*xrc4
     ...
     4      +860.d0*xrc2+32.d0*xrc4))*xrc*dbesk1(xrcd))-(1.d0/16.d0)*
...
c
  327 c(mm,ime)=1.d0
      go to 95
c
  331 c(mm,ime)=1.d0/pi32
      go to 95

  332 c(mm,ime)=1.d0/pi32
      go to 95
  
  333 c(mm,ime)=1.d0/pi32
      go to 95
  334 c(mm,ime)=1.d0/pi32
      go to 95
  335 c(mm,ime)=1.d0/pi32
      go to 95
  336 c(mm,ime)=1.d0/pi32
      go to 95
  337 c(mm,ime)=1.d0/pi32
      go to 95
  338 c(mm,ime)=1.d0/pi32
      go to 95
...
c        18  l2    (l square)
c        19  ssl2  (sigma1 dot sigma2 times l square)
	 ...
	 implicit real*8 (a-h, o-z)
	   ...
	   implicit real*8 (a-h, o-z)
	     ...
	     n=300
             ...
             g=(dexp(-z*y)/y)*(dlog(y+dsqrt(y*y-1)))
